                  ...
                  <div class="space-y-8 divide-y divide-gray-200 w-1/2 mt-10">
                    ...
                    <?php echo method_field('PUT'); ?>
                      <div class="sm:col-span-6">
                        ...
                        <div class="mt-1">
                          <input type="text" id="name" value="<?php echo e($menu->name); ?>" name="name" class="block w-full transition duration-150 ease-in-out appearance-none bg-white border border-gray-400 rounded-md py-2 px-3 text-base leading-normal transition duration-150 ease-in-out sm:text-sm sm:leading-5" />
                        </div>
...
unset($__errorArgs, $__bag); ?>
                      ...
                      <div class="sm:col-span-6 mt-5">
                        ...
                        <div class="">
                          <img src="<?php echo e(Storage::url($menu->image)); ?>" alt=""  class="w-32 h-32">
                        </div>
                        <div class="mt-1">
...
unset($__errorArgs, $__bag); ?>
                      ...
                      <div class="sm:col-span-6 mt-5">
                        ...
                        <div class="mt-1">
                          <input type="number"  min="0.00" max="1000.00"  id="price"  value="<?php echo e($menu->price); ?>" name="price" class="block w-full transition duration-150 ease-in-out appearance-none bg-white border border-gray-400 rounded-md py-2 px-3 text-base leading-normal transition duration-150 ease-in-out sm:text-sm sm:leading-5" />
                        </div>
...
<?php endif; ?>
<?php /**PATH C:\Users\sharif\Desktop\لارفل\حجز مطعم لارفل\resto_app\resources\views/admin/menus/edit.blade.php ENDPATH**/ ?>
...
<?php $component->withAttributes([]); ?>
    <!-- Main Hero Content -->
    <div id="dynamic-bg"
        class="container max-w-lg px-4 py-32 mx-auto text-center bg-center bg-no-repeat bg-cover md:max-w-none md:text-center">
        <div id="sqr">


            <h1 class="text-5xl mb-9 font-bold">
                <span class="inline md:block highlight">Welcome To Laravel Restaurant</span>
            </h1>

            <span class="mx-auto highlight mt-2 pr-64 pl-64   text-green-50 md:text-center lg:text-lg">
                Dive into a world where flavors meet freshness, and tradition meets innovation. At Laravel Restaurant, we're not just serving meals; we're crafting experiences that stay with you long after the last bite. Join us for a culinary journey that's as delightful as it is delicious.
            </span>
        </div>
    ...
    <section class="px-2 py-32 bg-white md:px-0">
        <div class="container items-center max-w-6xl px-8 mx-auto xl:px-5">
            ...
            > -->
                        <h3 class="text-xl highlight ">OUR STORY
                        </h3>
                        ...
                        <p class="mx-auto text-base text-gray-500 sm:max-w-md lg:text-xl md:max-w-3xl text-justify">
                            Welcome to Laravel Italian Restaurant, a culinary retreat that embodies the spirit of
                            authentic Italian cuisine.

                            It all started with our founder’s passion for Italian cooking and a desire to bring
                            authentic Italian flavors to the heart of our community. With recipes passed down through
                            generations and a commitment to sourcing the finest local ingredients, Laravel Italian
         
                            Enjoy crafting your story! 🍝✨
                        </p>
                ...
                <div class="w-full md:w-1/2">
                    <div class="w-full h-auto overflow-hidden rounded-md shadow-xl sm:rounded-xl">
                        <img src="<?php echo e(asset('logo 2.jpg')); ?>" alt="Logo">
            ...
            <div class="flex flex-wrap items-center -mx-3">
                <div class="order-1 w-full px-10 lg:w-1/2 lg:order-0">
                    <div class="w-full lg:max-w-md">
                        <h2 class="mb-4 text-2xl font-bold highlight ">About Us</h2>
                        <h2
                            class="mb-4 mt-4 text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-blue-500">
                            WHY CHOOSE US?</h2>
                ...
                <div class="w-full md:w-1/2 m-5 ">
                    <div class="w-full h-auto overflow-hidden rounded-md shadow-xl sm:rounded-xl">
                        <img src="<?php echo e(asset('logo 3.jpg')); ?>" alt="Logo">
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="pt-4 pb-12 pl-4  pr-4 bg-gray-800">
    ...
    <style>
        ...
        /* Apply to all text inside #sqr for Firefox */
        #sqr::-moz-selection {
            background: #ffc107;
            /* Highlight color */
            color: #ffffff;
        ...
        .highlight {
            background-color: #15a349db;
             color: #000000;
            /* Text color */
            padding: 0.25em 0.5em;
            /* Adjust spacing around the text */
            display: inline;
            /* Ensures the highlight wraps with the text */
            border-radius: 0.25em;
            /* Optional: rounded corners */
        }

        #dynamic-bg {
            background-image: url('https://source.unsplash.com/featured/?italian,food');
            /* Fetch a random image related to the Italian restaurant category from Unsplash */
...
<?php endif; ?>
<?php /**PATH C:\Users\sharif\Desktop\لارفل\حجز مطعم لارفل\resto_app\resources\views/welcome.blade.php ENDPATH**/ ?>
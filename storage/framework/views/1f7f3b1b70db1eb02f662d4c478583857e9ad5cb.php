                ...
                <div class="flex flex-col md:flex-row">
                    <div class="h-32 md:h-auto md:w-1/2">
                        <img class="object-cover w-full h-full"
                            src="<?php echo e(asset('logo 4.jpg')); ?>" alt="img" />
                    </div>
                                ...
                                <div class="mt-5 sm:col-span-6">
                                    ...
                                    <div class="mt-1">
                                        <input type="text" id="first_name" name="first_name"
                                            ...
                                            class="space-y-4 block w-full appearance-none bg-white border border-gray-400 rounded-md py-2 px-3 text-base leading-normal transition duration-150 ease-in-out sm:text-sm sm:leading-5" />
                                    </div>
                                ...
                                <div class="mt-5  sm:col-span-6">
                                    ...
                                    <div class="mt-5 mt-1">
                                        <input type="text" id="tel_number" name="tel_number"
                                            ...
                                            class="space-y-15 block w-full appearance-none bg-white border border-gray-400 rounded-md py-2 px-3 text-base leading-normal transition duration-150 ease-in-out sm:text-sm sm:leading-5" />
                                    </div>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="mt-5 mt-6 p-4 flex justify-end">
                                    <button type="submit"
...
<?php endif; ?>
<?php /**PATH C:\Users\sharif\Desktop\لارفل\حجز مطعم لارفل\resto_app\resources\views/reservations/step-one.blade.php ENDPATH**/ ?>
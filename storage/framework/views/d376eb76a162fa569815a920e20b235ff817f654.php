...
<body class="font-sans antialiased mx-auto w-1000px">

        <div class="bg-white shadow-md" x-data="{ isOpen: false }">
            <nav class="container px-6 py-8 mx-auto md:flex md:justify-between md:items-center">
                <div class="flex items-center justify-between">
                    <a class="text-xl font-bold bg-gradient-to-r from-red to-gray-600 hover:text-green-400 bg-clip-text md:text-2xl" href="/">
                        LARAVEL RETURANT
                    </a>
                ...
                <div :class="isOpen ? 'flex' : 'hidden'"
                    ...
                    <a class=" font-bold bg-gradient-to-r from-red to-gray-600 hover:text-green-400 bg-clip-text md:text-2xl"
                    href="/">Home</a>
                    <a class=" font-bold bg-gradient-to-r from-red to-gray-600 hover:text-green-400 bg-clip-text md:text-2xl"
...
<?php /**PATH C:\Users\sharif\Desktop\لارفل\حجز مطعم لارفل\resto_app\resources\views/layouts/guest.blade.php ENDPATH**/ ?>
            ...
            <main class="m-2 p-8 w-full">
                <div>
                   <?php if(@session()->has('danger')): ?>
                    <div class="mb-4 rounded-lg bg-red-100 p-4 text-sm text-red-700 dark:bg-red-200 dark:text-red-800" role="alert"><span class="font-medium">Danger alert!</span> <?php echo e(session()->get('danger')); ?></div>
                    <?php endif; ?>
                    <?php if(@session()->has('success')): ?>
                    <div class="mb-4 rounded-lg bg-green-100 p-4 text-sm text-green-700 dark:bg-green-200 dark:text-green-800" role="alert"><span class="font-medium">Success alert!</span> <?php echo e(session()->get('success')); ?></div>
                    <?php endif; ?>
                    <?php if(@session()->has('warning')): ?>
                    <div class="mb-4 rounded-lg bg-yellow-100 p-4 text-sm text-yellow-700 dark:bg-yellow-200 dark:text-yellow-800" role="alert"><span class="font-medium">Warning alert!</span><?php echo e(session()->get('warning')); ?></div>
                    <?php endif; ?>
                </div>
                <?php echo e($slot); ?>
...
<?php /**PATH C:\Users\sharif\Desktop\لارفل\حجز مطعم لارفل\resto_app\resources\views/layouts/admin.blade.php ENDPATH**/ ?>